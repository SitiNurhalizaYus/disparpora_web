                ...
                <div class="container-fluid navbar-inner">
                    <div class="d-flex align-items-center justify-content-between w-100 landing-header">
                        ...
                        <div class="d-flex align-items-center d-xl-none">
                            ...
                            <a href="{{ url('/beranda') }}" class="navbar-brand ms-3 d-xl-none">
                                <!-- Logo Start -->
                                <img src="{{ asset('/' . str_replace('/xxx/', '/300/', $setting['logo-geopark'])) }}">
                                <!-- Logo End -->
                        ...
                        <nav id="navbar_main" class="mobile-offcanvas nav navbar navbar-expand-xl hover-nav horizontal-nav">
                            <div class="container-fluid p-lg-0">
                                ...
                                <div class="d-flex justify-content-center w-100">
                                    <ul class="navbar-nav iq-nav-menu list-unstyled d-flex justify-content-center w-100" id="header-menu">
                                        ...
                                        <li class="nav-item dropdown mx-2">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <li><a class="dropdown-item" href="{{ url('/profil/') }}">Struktur Organisasi Dinas</a></li>
                                                <li><a class="dropdown-item" href="{{ url('/profil/') }}">Visi Misi</a></li>
                                                <li><a class="dropdown-item" href="{{ url('/profil/') }}">Tujuan Strategis</a></li>
                                                <li><a class="dropdown-item" href="{{ url('/profil/') }}">Sasaran Strategis</a></li>
                                                <li><a class="dropdown-item" href="{{ url('/team') }}">Struktur Organisasi Pimpinan</a></li>
                                            </ul>
                                        </li>
                                        <li class="nav-item dropdown mx-2">
                                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <li class="nav-item mx-2">
                                            <a class="nav-link" href="{{ url('/lokawisata') }}">Lokawisata</a>
                                        </li>
                                        <li class="nav-item mx-2">
    ...
    <footer>
        <div class="bg-secondary inner-box ">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <a href="{{ url('/beranda') }}" class="navbar-brand  d-flex align-items-center">
                            <img src="{{ asset('/' . str_replace('/xxx/', '/300/', $setting['logo-geopark'])) }}">
                    ...
                    <div class="col-md-2 mt-md-0 mt-4">
                        ...
                        <ul class="m-0 p-0 list-unstyled text-white">
                            <li class="mb-3"><a href="{{ url('/about') }}" style="color: lightgray;">About us</a>
                            </li>
                            <li class="mb-3"><a href="{{ url('/feature') }}"
                                    style="color: lightgray;">Features</a></li>
                            <li class="mb-3"><a href="{{ url('/pricing') }}" style="color: lightgray;">Pricing</a>
                            </li>
                    ...
                    <div class="col-md-2 mt-md-0 mt-4">
                        ...
                        <ul class="m-0 p-0 list-unstyled text-white">
                            ...
                            <li><a href="{{ url('/hubungikami') }}" style="color: lightgray;">Contact Us</a></li>
                        </ul>
                    </div>
                        ...
                        <ul class="list-unstyled p-0 m-0 d-flex mt-4">
                            <li>
                                <a href="{{ $setting['socmed-facebook'] }}" target="_blank">
                                    <img src="{{ asset('assets/images/brands/08.png') }}" alt="fb"
                                        loading="lazy" class="rounded-pill">
                                </a>
                            </li>
                            <li class="ps-3">
                                <a href="{{ $setting['socmed-twitter'] }}" target="_blank">
                                    <img src="{{ asset('assets/images/brands/09.png') }}" alt="gm"
                                        loading="lazy" class="rounded-pill">
                                </a>
                            </li>
                            <li class="ps-3">
                                <a href="{{ $setting['socmed-instagram'] }}" target="_blank">
                                    <img src="{{ asset('assets/images/brands/10.png') }}" alt="im"
                                        loading="lazy" class="rounded-pill">
                                </a>
                            </li>
                        </ul>
