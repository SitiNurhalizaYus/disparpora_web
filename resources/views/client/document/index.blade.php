        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h3 class="text-white mb-4">Document Management</h3>
    ...
    <div class="section-card-padding bg-white">
        <div class="container">
            <div class="d-flex justify-content-between mb-3">
                ...
                <div>
                    <input type="text" class="form-control" placeholder="Search by title..." style="width: 200px;">
                </div>
            </div>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>SE Peringatan Hari Lahir Pancasila 2024</td>
                        <td>Pengumuman</td>
                        <td>31 May 2024</td>
                        <td><button class="btn btn-red">Unduh</button></td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>Laporan Realisasi Anggaran Seluruh SKPD Tahun 2023</td>
                        <td>Informasi Keuangan Daerah</td>
                        <td>03 Apr 2024</td>
                        <td><button class="btn btn-red">Detail</button></td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>Informasi Realisasi Pembiayaan Daerah Tahun 2023</td>
                        <td>Informasi Keuangan Daerah</td>
                        <td>03 Apr 2024</td>
                        <td><button class="btn btn-red">Detail</button></td>
                    </tr>
